<?php
$page_title = 'Our Team';
$page_description = 'Meet the experienced leadership team at BOSE ENTERPRISES with 7-22+ years of expertise in solar EPC and infrastructure projects.';
            ...
            <div class="row g-4" data-be-stagger="120">
                ...
                <div class="col-lg-4 col-md-6" data-be-animate="fadeInUp">
                    <div class="be-team-card be-team-card--detail reveal">
                        ...
                        <p class="be-team-card__desc">Experienced in electrical project management and commissioning activities.</p>
                    </div>
                </div>
            </div>
        </div>
