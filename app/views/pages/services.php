...
<main class="main-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <h1 class="be-page-hero__title reveal-up">Solar EPC &amp; Infrastructure Services</h1>
                    <p class="be-page-hero__lead reveal-up">Six core services covering EPC, civil works, electrical works, installation, commissioning support, and O&amp;M.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="be-section be-section--white">
        <div class="container">
            <div class="be-section__head">
                <p class="be-kicker reveal-down">What We Deliver</p>
                <h2 class="be-section__title reveal-up">Six Services. One Operating Standard.</h2>
                <p class="be-section__sub reveal-up">Consistent execution pattern across every work package.</p>
            </div>

            <div class="be-slider reveal-up" data-be-slider="services-page" data-be-autoplay="true" data-be-interval="4000" data-be-pause-hover="true">
    ...
    <section class="be-section be-section--light">
        <div class="container">
            <div class="be-section__head">
                <p class="be-kicker reveal-down">Why Us</p>
                <h2 class="be-section__title reveal-up">A Team Built For Delivery</h2>
                <p class="be-section__sub reveal-up">Practical experience, clear process, and accountable execution.</p>
            </div>
    ...
    <section class="be-cta">
        <div class="container text-center">
            <div class="be-cta__inner reveal-scale">
                ...
                <p class="be-cta__text reveal-up">Contact our team to discuss your solar infrastructure requirements.</p>
