      ...
      <div class="row">
        <div class="col-lg-8 m-auto">
          <div class="hero-heading-area heading1 text-center">
            ...
            <a href="index.php" class="backline">Home <i class="fa-solid fa-angle-right"></i><span>Frequently Asked Questions</span></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-12">
          <div class="faq-auhtoir-area1">
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="accordion accordion-flush active" id="accordionFlushExample2">
                  <div class="accordion-item">
                    <h2 class="accordion-header">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="faq-auhtoir-area1">
            <div class="row">
              <div class="col-lg-6">
                <div class="accordion accordion-flush active" id="accordionFlushExample3">
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                    ...
                    <div id="flush-collapse1" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample3">
                      <div class="accordion-body">Whether you're wondering about our pricing plans, process <br> installation , or sustainability initiatives.</div>
                    </div>
                  </div>
                  <div class="space20"></div>
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapse2" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample3">
                      <div class="accordion-body">Whether you're wondering about our pricing plans, process <br> installation , or sustainability initiatives.</div>
                    </div>
                  </div>
                  <div class="space20"></div>
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapse3" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample3">
                      <div class="accordion-body">Whether you're wondering about our pricing plans, process <br> installation , or sustainability initiatives.</div>
                    </div>
                  </div>
                  <div class="space20"></div>
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapse4" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample3">
                      <div class="accordion-body">Whether you're wondering about our pricing plans, process <br> installation , or sustainability initiatives.</div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapse5" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample3">
                      <div class="accordion-body">Whether you're wondering about our pricing plans, process <br> installation , or sustainability initiatives.</div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-6">
                <div class="accordion accordion-flush active" id="accordionFlushExample4">
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                    ...
                    <div id="flush-collapse6" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample4">
                      <div class="accordion-body">Whether you're wondering about our pricing plans, process <br> installation , or sustainability initiatives.</div>
                    </div>
                  </div>
                  <div class="space20"></div>
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapse7" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample4">
                      <div class="accordion-body">Whether you're wondering about our pricing plans, process <br> installation , or sustainability initiatives.</div>
                    </div>
                  </div>
                  <div class="space20"></div>
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapse8" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample4">
                      <div class="accordion-body">Whether you're wondering about our pricing plans, process <br> installation , or sustainability initiatives.</div>
                    </div>
                  </div>
                  <div class="space20"></div>
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapse9" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample4">
                      <div class="accordion-body">Whether you're wondering about our pricing plans, process <br> installation , or sustainability initiatives.</div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item">
                    ...
                    <div id="flush-collapse10" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample4">
                      <div class="accordion-body">Whether you're wondering about our pricing plans, process <br> installation , or sustainability initiatives.</div>
                    </div>
                  </div>
                </div>
