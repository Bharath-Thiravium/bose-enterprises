      ...
      <div class="row">
        <div class="col-lg-7 m-auto">
          <div class="hero-heading-area heading1 text-center">
            <h1>Case Studies</h1>
            <a href="index.php" class="backline">Home <i class="fa-solid fa-angle-right"></i><span>Case Studies</span></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="case-author-boxarea">
            ...
            <div class="case-content">
              <div class="text">
                <p>Electicity Solutions</p>
                <a href="case-single.php">Bright Sparks</a>
              </div>
              <div class="icons">
                <a href="case-single.php"><span> <i class="fa-solid fa-arrow-right"></i></span></a>
              </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="case-author-boxarea">
            ...
            <div class="case-content">
              <div class="text">
                <p>Electicity Solutions</p>
                <a href="case-single.php">Electrical Endeavors</a>
              </div>
              <div class="icons">
                <a href="case-single.php"><span> <i class="fa-solid fa-arrow-right"></i></span></a>
              </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="case-author-boxarea">
            ...
            <div class="case-content">
              <div class="text">
                <p>Electicity Solutions</p>
                <a href="case-single.php">Power Portraits</a>
              </div>
              <div class="icons">
                <a href="case-single.php"><span> <i class="fa-solid fa-arrow-right"></i></span></a>
              </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="case-author-boxarea">
            ...
            <div class="case-content">
              <div class="text">
                <p>Electicity Solutions</p>
                <a href="case-single.php">Energy Evolution</a>
              </div>
              <div class="icons">
                <a href="case-single.php"><span> <i class="fa-solid fa-arrow-right"></i></span></a>
              </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="case-author-boxarea">
            ...
            <div class="case-content">
              <div class="text">
                <p>Electicity Solutions</p>
                <a href="case-single.php">Eco-Electric Epics</a>
              </div>
              <div class="icons">
                <a href="case-single.php"><span> <i class="fa-solid fa-arrow-right"></i></span></a>
              </div>
