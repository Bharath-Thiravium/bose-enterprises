...
<body class="homepage1-body tg-heading-subheading animation-style3">
  ...
  <?php include(__DIR__ . '/../components/partials/header-single/navbar.php'); ?>
  ...
  <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary rounded-2" tabindex="0">
    ...
    <!--===== SERVICE AREA STARTS =======-->
    <div class="service1-section-area sp2" id="service">
      <div class="container">
        <div class="row">
    ...
    <!--===== WORK AREA STARTS =======-->
    <div class="work1-section-area sp1" id="work">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
    ...
    <!--===== TEAM AREA STARTS =======-->
    <div class="team1-section-area sp2" id="team">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 m-auto">
    ...
    <!--===== BLOG AREA ENDS =======-->
    <div class="blog1-section-area sp2" id="blog">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 m-auto">
